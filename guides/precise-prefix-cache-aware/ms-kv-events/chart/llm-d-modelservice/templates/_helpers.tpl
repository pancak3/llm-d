...
{{- end }}
{{- $autoResourceEnabled := and (ge (int $tensorParallelism) 1) (ne $acceleratorResource "") (not (default false .Values.accelerator.disableDefaultResource)) }}
{{- if and $autoResourceEnabled (not (hasKey $limits $acceleratorResource)) }}
...
{{- end }}
{{- if and $autoResourceEnabled (not (hasKey $requests $acceleratorResource)) }}
